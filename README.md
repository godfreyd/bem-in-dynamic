...
1. [Реализация общей функциональности](Общая-часть) — код для работы с Twitter и YouTube APIs.
2. [Реализация функциональности для работы с Twitter Search API](#Работа-с-twitter-search-api) — код для работы с Twitter API.
3. [Реализация функциональности для работы с YouTube Data API](Работа-с-youtube-data-api) — код для работы с YouTube API.
