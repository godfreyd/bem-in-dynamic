...
5. Скопируйте полученный код.
    ...
    **Пример**
    ...
    `eHZ6MWV2RlM0d0VFUFRHRUZQSEJvZzpMOHFxOVBaeVJnNmllS0dFS2hab2xHQzB2SldMdzhpRUo4OERSZHlPZwo=`
...
Разработка функциональности, направленной на работу с программными интерфейсами, сводится к следующим шагам:
