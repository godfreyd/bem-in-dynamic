...
> **Примечание.** Postman необходим для получения OAuth 2 Bearer-токена с помощью POST-запроса в обмен на [Base64](https://en.wikipedia.org/wiki/Base64) код. Код генерируется из пары ключей Consumer Key, Consumer Secret.
