...
10. Нажмите кнопку **Send**.
    ...
    > **Важно!** Сохраните полученные токен и ключи (Consumer Key и Consumer Secret).

## Получение OAuth-токена для Google

Google также предлагает приложениям возможность выдавать аутентифицированные запросы от имени самого приложения. Реализация OAuth в Google отличается от реализации в Twitter тем, что Google ограниивает время жизни токена.
