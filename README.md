...
SSSR — это сервис для поиска твитов и видео с заданным набором параметров. Параметры поиска передаются в APIs Twitter и YouTube в виде HTTP-запроса методом GET. APIs формируют ответ в виде JSON-документа.
