...
Изменения, связанные с отправкой запросов, получением данных и их обработкой, рассматриваются в следующих подразделах:

* [Общие изменения](Общие-изменения) — код для обработки общих данных.
* [Работа с Twitter Search API](#Работа-с-twitter-search-api) — код для работы с Twitter API.
* [Работа с YouTube Data API](Работа-с-youtube-data-api) — код для работы с YouTube API.
