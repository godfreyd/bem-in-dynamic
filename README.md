...
Следующий пример демонстрирует логику сборки для приложения **Hello, World**.
...
> **Примечание.** Технология реализация BEMTREE указана через логический оператор `||` (ИЛИ), потому в BEMTREE используются только режимы ориентированные на работу с данными. Если динамической передачи данных не предполагается, можно использовать только BEMHTML.
...
![BEMTREE](static/images/440px-TempEngGen015.svg.png =250px)
