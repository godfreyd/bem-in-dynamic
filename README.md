...
У программистов есть традиция: начинать программирование с приложения "Hello, World". И это первое приложение, которое мы создадим. После чего модифицируем его до желаемого Social Services Search Robot.
