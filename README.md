...
Все примеры листингов, описанных в документе, успешно прошли проверку в версиях:
...
* Разделим функциональность файла `index.js` на следующие модули:
    ...
    * `app.js` — будет отвечать за *монтирование* промежуточных модулей (делает их доступными в приложении);
