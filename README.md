...
После того как данные были получены, их необходимо добавить тем блокам, которые их ожидают. Как и в примере с приложением **Hello, World**, за обработку полученных данных отвечает [BEMTREE](#bemtree).
...
В этом разделе мы ближе познакомимся с концепцией модуля Node и вкратце рассмотрим основные модули, необходимые для работы приложения.
