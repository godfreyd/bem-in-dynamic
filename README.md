...
> **Примечание.** Postman необходим для получения OAuth 2 Bearer-токена с помощью POST-запроса в обмен на код. Код генерируется из пары Consumer Key, Consumer Secret.
