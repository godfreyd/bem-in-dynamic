...
Клиентский JavaScript описывается в файлах с расширением `.js`.
...
* Для удобства хранения статических файлов создадим в директории `static` поддиректории: `css`, `images`, `js`.
