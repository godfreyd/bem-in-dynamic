...
Предлагает приложениям возможность выдавать аутентифицированные запросы от имени самого приложения.
...
4. Получите [OAuth 2 Bearer Token](#Как-получить-bearer_token).
5. Используйте полученный токен и  ключи в запросах к Twitter Search API.

### Как получить OAuth 2 Bearer Token
...
Предлагает приложениям возможность выдавать аутентифицированные запросы от имени самого приложения. Для дополнительной безопасности полученный токен имеет срок жизни. После чего должен быть обновлен.
