...
* Корректные заголовки Accept и Content-Type.

  > **Примечание.** Twitter Search API поддерживает только один Mime-тип, application/x-www-form-urlencoded;charset=UTF-8. Любое другое значение приведет к ошибке формата данных.
