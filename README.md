...
> **Важно!** Twitter Search API ориентирован на релевантность, а не на полноту данных. Это означает, что некоторые твиты или пользователи могут отсутствовать в результатах поиска. Если для вас важна полнота получаемых данных, используйте [Streaming API](https://dev.twitter.com/streaming/overview).
