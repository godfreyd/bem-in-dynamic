...
> **Примеччание.** Подробное описание некоторых файлов и диреторий приводится ниже.
...
Часто `*.bemdecl.js`-файлы называют декларациями. Задача декларации — определить, что и в каком порядке подключать в сборку.
