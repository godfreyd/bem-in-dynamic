...
5. Получите [OAuth-токен](#Как-получить-oauth-токен-в-обмен-на-код) (OAuth 2 Bearer-токен) в обмен на код.
6. Используйте полученный токен и ключи в запросах к Twitter Search API.

> **Примечание.** Postman необходим для получения OAuth 2 Bearer-токена с помощью POST-запроса в обмен на код полученный методом Base64. 

### Как закодировать строку

Чтобы закодировать строку методом Base64:

1. Перейдите на сайт [www.base64encode.org](https://www.base64encode.org).
...
5. Скопируйте полученный Base64-код из поля ниже.
