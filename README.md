...
Подробное описание некоторых файлов и директорий приводится ниже.
...
Cодержит файлы полученные в результате [сборки](#enb). Такие файлы в БЭМ-методологии принято называть бандлами.
