...
На базе этой инфраструктуры (приложения **SSSR**) можно реализовать множество динамических БЭМ-проектов для решения частных задач. APIs Twitter и YouTube можно заменить любой базой данных с различными данными.
...
Итак, нами упорядочена структура проекта, получены все необходимые [доступы](#Получение-oauth-токенов) для работы с OAuth-серверами Twitter и Google и при запуске приложения (команда `npm run dev`), по-прежнему выводится сообщение:
...
В серверную часть приложения остается внести изменения, направленные на работу с APIs и обработкой полученных данных.

Процесс написания необходимого кода сводится к следующим шагам:

1. [Реализация общей функциональности](#Реализация-общей-функциональности) — код для работы с Twitter и YouTube APIs.
2. [Реализация функциональности для работы с Twitter Search API](#Реализация-функциональности-для-работы-с-twitter-search-api) — код для работы с Twitter API.
3. [Реализация функциональности для работы с YouTube Data API](#Реализация-функциональности-для-работы-с-youtube-data-api) — код для работы с YouTube API.
