...
**BEMTREE** является частью шаблонизатора [bem-xjst](https://ru.bem.info/platform/bem-xjst/) и преобзазует BEMJSON с данными в BEMJSON с БЭМ-деревом.
...
**BEMHTML** является частью шаблонизатора [bem-xjst](https://ru.bem.info/platform/bem-xjst/) и преобзазует BEMJSON в HTML.
