...
**Помните:** когда вы описали шаблон (BEMHTML или BEMTREE) с каким-то блоком внутри, вы просто добавли HTML-элемент. Чтобы стили и скрипты этого блока попали в сборку, необходимо описать зависимость от него.
