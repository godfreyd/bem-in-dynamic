...
Увидеть одним списком все технологии БЭМ — полдела. Теперь подробнее.
...
При использовании технологии [DEPS](#deps) на проекте, в декларации обычно отражают один блок, например `root`:
...
Как же подключаются в проект остальные блоки? Блок из декларации следует рассматривать как центральную «точку входа». Все остальные БЭМ-сущности попадают в сборку по зависимостям:
