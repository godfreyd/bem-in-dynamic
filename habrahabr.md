...
БЭМ — это лайфхак для стартаперов. По сравнению со многими другими фреймворками и технологиями начало работы с БЭМ требует определенных усилий, но это того стоит. Во все технологии, фреймворки и библиотеки БЭМ изначально заложены принципы хорошей архитектуры. И именно это делает их такими непонятными на первый взгляд и любимыми в итоге.
...
Давайте посмотрим, какие же вообще есть технологии в БЭМ:
...
Суть проста — например, на проекте 10 страниц, следовательно 10 деклараций. В каждой определен список в виде вышеописанного примера. При сборке проекта, сборщик обходит все декларации и по их описанию создает бандлы для каждой из страниц.
