...
Цель этой статьи заключается в том, чтобы дать читателю представление о базовой функциональности технологий БЭМ. Мы сознательно не станем рассматривать вопросы верстки и клиентского JavaScript, чтобы избежать участи «подчеркивания в классах».
...
Название технологии происходит он от английского слова dependence и обозначает желание подключить в сборку какую-то БЭМ-сущность. Изучающие БЭМ порой забывают о декларативности технологий и не понимают, почему для описанного в шаблоне блока, не собрались его стили или скрипты.

**Правило:** если БЭМ-сущности разнесены по файловой структуре проекта и не отражены в декларации, недостаточно описать их в шаблоне. Потребуется указать зависимости от них.
