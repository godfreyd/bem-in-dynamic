...
Цель статьи — рассказать о шаблонном репозитории [bem-express](https://github.com/bem/bem-express), который позволяет развернуть динамический БЭМ-проект на Node.js в один клик. На его основе мы продолжим учиться БЭМ и разберем, за что отвечает каждая технология. Мы сознательно не будем рассматривать вопросы верстки и клиентского JavaScript, чтобы избежать участи «подчеркивания в классах».
